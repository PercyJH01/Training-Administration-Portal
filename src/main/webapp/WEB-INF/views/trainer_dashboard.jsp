...
<body>
	...
	<table>
		...
		<tr>
			...
			<td><a
				href="<%=request.getContextPath()%>/UpdateTrainer/<%=trainer.getTrainerId()%>">updateTrainer</a>
			</td>
			<td><a
				href="<%=request.getContextPath()%>/delete_trainer/<%=trainer.getTrainerId()%>">DeleteTrainer</a>
			</td>
